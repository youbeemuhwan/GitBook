...
## <mark style="color:yellow;">CSRF 공격이 무엇이고, 어떻게 피할 수 있는지 설명해주세요.</mark>
...
1. 해당 사이트에 사용자가 로그인 되어있는 상태여야 한다.
2. 사용자가 공격자가 만들어놓은 피싱사이트를 클릭해야 한다.

그래야 유저의 세션 정보를 갈취 할수 있기에!

3. 공격자는 해당 사이트의 요청 방식에 대해 파악하고 있어야 한다.
